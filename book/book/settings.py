...
SECRET_KEY = 'django-insecure-qtns!mis85ehoc(9+^jcub(f55)hsb%8bn@b#r(lg^7$_-b(t+'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'itstheboy19666@gmail.com'
EMAIL_HOST_PASSWORD = 'gsam admc uyge ckju'  # Use app password for Gmail